...
import fleetDetailImg from '@/src/assets/fleet-detail.jpg';
...
export const metadata: Metadata = {
  ...
  description: 'Compliance-first fleet detailing in Bozeman, MT. DOT inspection readiness, CSA score protection, recurring maintenance programs, and zero-downtime scheduling.',
  alternates: { canonical: 'https://www.velocitydetailingmt.com/fleet-detailing-bozeman-mt' },
  openGraph: {
    title: 'Fleet Detailing Bozeman MT | Velocity Car Detailing',
    description: 'Compliance-first fleet detailing in Bozeman, MT. DOT inspection readiness, CSA score protection, recurring maintenance programs.',
    url: 'https://www.velocitydetailingmt.com/fleet-detailing-bozeman-mt',
  },
  twitter: {
    title: 'Fleet Detailing Bozeman MT | Velocity Car Detailing',
    description: 'Compliance-first fleet detailing in Bozeman, MT. DOT inspection readiness, CSA score protection.',
  },
};
