...
import boatDetailImg from '@/src/assets/boat-detail.jpg';

export const metadata: Metadata = {
  title: 'Boat Detailing Bozeman MT | Velocity Car Detailing',
  description: 'Professional boat detailing in Bozeman, MT. Gel coat restoration, interior cleaning, and full boat detail packages. We come to you.',
  alternates: { canonical: 'https://www.velocitydetailingmt.com/boat-detailing-bozeman-mt' },
  openGraph: {
    title: 'Boat Detailing Bozeman MT | Velocity Car Detailing',
    description: 'Professional boat detailing in Bozeman, MT. Gel coat restoration, interior cleaning, and full boat detail packages.',
  ...
  return (
    <div className="min-h-screen bg-background">
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify(boatSchema) }}
      />
      <Header />
