...
const LocationHero = ({ city }: LocationHeroProps) => {
  return (
    <section
      id="home"
    ...
    >
      <div
        ...
        role="img"
        aria-label={`Velocity Car Detailing professional auto detailing in ${city}, MT`}
      />
      ...
      <div className="relative z-10 container mx-auto px-4 md:px-8 pt-20">
        <div className="max-w-3xl">
          ...
          <p className="mt-6 text-lg md:text-xl text-foreground/80 max-w-xl animate-fade-up delay-100">
            Your time is valuable. That's why Velocity Car Detailing brings professional detailing services right to your doorstep in {city}, MT.
          </p>
